    ...
    const fetchUserCount = async () => {
      try {
        ...
        const response = await axios.get(
          `${BASE_URL}/api/v1/users/user_filter`,
          {
            params: {
  ...
  return (
    <div className="h-screen w-full font-poppins">
          ...
          <div className="flex flex-col justify-between px-4">
            <div className="flex mt-4">
              ...
              {languages.map((lang, index) => (
                <button
                  key={index}
                  className="p-2 font-poppins my-2 mx-2 border-2 border-accent bg-zinc-100 rounded-[8px] opacity-[0.3] cursor-not-allowed"
                >
                  {lang}
                </button>
              ))}
            ...
            <div className="rounded-md">
              ...
              <p className="font-poppins">
                <span className="font-bold">Number of Target Users:</span>{" "}
        ...
        <div className="px-4 rounded-md w-1/4">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex flex-col gap-2 opacity-30">
              ...
              <button className="w-1/2 text-start m-0 border-2 border-accent font-bold font-poppins rounded-[8px] p-2">
                None
              </button>
            </div>
            <div className="flex flex-col gap-2 opacity-30">
            ...
            <div className="flex flex-col gap-2">
              ...
              <button className="w-1/2 text-start m-0 border-secondary border-2 font-bold text-secondary bg-white font-poppins rounded-[8px] p-2">
      ...
      <Modal
        ...
        contentLabel="Confirm Send"
        className="w-full h-screen flex flex-col items-center justify-center glass"
        ariaHideApp={false}
      >
        <div className="flex flex-col items-center justify-center text-center">
          <h2 className="font-bold font-poppins mb-1">Confirm Send</h2>
          <p className="font-poppins">
            You are about to send a message to {userCount} user(s). Are you sure
