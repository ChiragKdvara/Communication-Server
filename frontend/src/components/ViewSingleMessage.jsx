...
const ViewSingleMessage = () => {
  ...
  const handleUserViewMessage = (id, title, content, reference_id) => {
    navigate(`/message-details/${id}`, {
      state: { id, title, content, reference_id },
    });
  };
  ...
  return (
    <div className="h-screen w-full font-poppins">
      ...
      <div className="mb-2 px-4">
        ...
        {isOpen && (
          <div
            className={`flex justify-between items-start px-4 m-0 border-primary border-solid border-2 rounded-br-[8px] rounded-bl-[8px] ${
              isOpen ? " border-t-0" : ""
            }`}
          >
