        ...
        {isOpen && (
          <div className={`flex justify-between items-start px-4 m-0 border-primary border-solid border-2 rounded-br-[8px] rounded-bl-[8px] ${isOpen ? ' border-t-0' : ''}`}>
            ...
            <div className="flex flex-col gap-2 py-4 mt-4 mb-4">
              ...
              <select id="languages" value={selectedLanguage} onChange={handleChange} disabled className="select select-bordered font-poppins w-48 border-2 border-accent rounded-[8px] p-2">
                ...
                filteredUsers.map((user) => (
                  <div key={user.exp_message_id} className="flex items-center justify-between">
                    <div className="w-full flex items-center justify-between">
                      ...
                      <p
                        className="btn-link text-secondary font-medium font-poppins hover:cursor-pointer pr-4"
